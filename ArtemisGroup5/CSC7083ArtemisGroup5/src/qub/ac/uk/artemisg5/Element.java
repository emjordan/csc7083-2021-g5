...
I have included getters and setters for everything but can't remember if that is good practice.. this wouldn't be needed for things that are constant like development costs
*/
...
public class Element {
	...
	each element has 4 development levels that must be achieved to be completed, a cost is associated with each development level
